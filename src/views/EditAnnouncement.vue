<template>
  <v-container>
    ...
    <v-row>
      <v-col class="body-2">
        <div class="heading font-weight-bold">Do NOT put sensitive links on announcements as Harker MS Bell does not have authentication. Instead, link to a related Schoology post for sensitive links when possible.</div>
